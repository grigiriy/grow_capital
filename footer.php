      ...
      <div class="row">
        ...
        <div class="col-md-5 mt-20">
          ...
          <div class="icon-listed">
            ...
            <p itemprop="telephone"><a href="tel:+74993212048" class="fd-n fc-base">+7 499 321-20-48</a></p>
          </div>
          <div class="icon-listed">
            ...
            <p itemprop="email"><a href="mailto:info@growcapital.ru" class="fd-n fc-base">info@growcapital.ru</a></p>
          </div>          
            <p class="pt-20 mb-0" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
              <span itemprop="addressLocality">Москва</span>,
              <span itemprop="streetAddress">Хомутовский тупик, 5-7с7</span>
            </p>
        </div>
      </div>
    </div>
    <div>
      <div class="container-w">
        <div class="row">
          <div class="col-12">
            <p class="fs-s fc-07">
              <span class="icon-copyright"></span><span itemprop="foundingDate">2020</span> -
              <span itemprop="name">Grow Capital</span>
            </p>
          </div>
        </div>
      </div>
