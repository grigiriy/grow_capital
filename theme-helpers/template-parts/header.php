      ...
      <div class="pt-60 pb-60 fc-light">
        ...
        <div class="simple_form lim-12">
          <div class="row">
            ...
            <div class="col-lg-6">
              <p class="fs-l fw-5">Выберите мессенджер или оставьте <span class="nowrap">e-mail</span>, и мы пришлем вам доступ ко всем бесплатным сервисам и образовательным программам.
              </p>
              <p class="fs-l fw-5">
              </p>
            </div>
