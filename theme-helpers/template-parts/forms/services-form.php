<form class="form-goriz" id="ltForm4997061" action="https://growcapital.getcourse.ru/pl/lite/block-public/process-html?id=964418017" method="post" data-open-new-window="0"><input type="hidden" name="formParams[setted_offer_id]"><br>
...
<script>
	window.addEventListener('load', function() {
		let loc = document.getElementById("32614060087396456a2");
		loc.value = window.location.href;
		let ref = document.getElementById("32614060087396456a2ref");
